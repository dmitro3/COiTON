...
async function main() {
    ...
    await (await contract.createAdministration(data.admin, "lagos", "lagos")).wait();
    await (await contract.addAgent("lagos", { id: data.agent, name: "Javis", code: "code", region: "region", bio: "bio", deleted: false })).wait();
